...
function page({}: Props) {
  ...
  const fetchSubject = async () => {
    const res = await getSubjectById(id.toString())
  ...
  const fetchPakets = async () => {
    const res = await getAllPaketsBySubjectId(id.toString())
  ...
  const onDeleteSubject = async () => {
    ...
    const res = await deleteSubject(id.toString())
  ...
  const onDeletePaket = async () => {
    ...
    const res = await deletePaketByPaketId(selectedDeletedPaket._id.toString())
